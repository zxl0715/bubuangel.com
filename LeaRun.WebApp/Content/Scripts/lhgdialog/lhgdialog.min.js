...
(function (a, b, c) {
    ...
    v.fn = v.prototype = {
        ...
        _init: function (a) {
            ...
            c.closed = !1,
            c.data = a.data,
            a.icon && !f ? (a.min = !1, a.max = !1, d.icon[0].style.display = "", d.icon[0].innerHTML = '<img src="' + a.path + "skins/icons/" + a.icon + '" class="ui_icon_bg"/>') : d.icon[0].style.display = "none",
...
function (a, b, c) {
    ...
    b.tips = function (a, c, e, f) {
        var g = e ?
        function () {
            this.DOM.icon[0].innerHTML = '<img src="' + this.config.path + "skins/icons/" + e + '" class="ui_icon_bg"/>',
